...
코딩 지식이 전혀 없어도 설치할 수 있도록 아래 순서대로 따라 하시면 됩니다.
...
1. Creative Cloud 앱을 열고 왼쪽 메뉴에서 "스톡 및 마켓플레이스" 또는 검색창에 **"UXP Developer Tool"** 을 검색해서 설치합니다.
   - 안 보이면 [Adobe 공식 페이지](https://developer.adobe.com/photoshop/uxp/)에서 직접 받을 수도 있습니다.
...
**영상으로 내보내고 나면** 지금까지 기록된 장면들은 자동으로 정리되고, 그 시점부터 새로 기록이 시작됩니다. 즉 그림 하나를 완성할 때까지 중간중간 여러 번 영상으로 뽑아도 되고, 마지막에 그 영상들을 이어 붙이면 전체 작업 과정이 됩니다.
...
- 오래 기록할수록 임시로 저장되는 그림 데이터 용량이 커집니다. 영상으로 내보내고 나면 자동으로 정리되니, 중간중간 내보내기를 해주시면 용량 걱정 없이 쓸 수 있습니다.
