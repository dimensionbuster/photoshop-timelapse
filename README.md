...
**영상 내보내기는 기록을 지우지 않습니다.** "영상 내보내기"를 여러 번 눌러도 그때마다 지금까지 기록된 전체 과정을 처음부터 다시 하나의 영상으로 만듭니다. 중간중간 미리보기 삼아 여러 번 내보내 봐도 괜찮지만, 기록 자체를 구간별로 나누는 기능은 아닙니다. 기록을 완전히 새로 시작하고 싶을 때는 "기록 초기화"를 눌러주세요.
